...
SECRET_KEY = 'django-insecure-5ced&)i4-88m+sd(^1k0+v6$@a&)%v-m2#k4ryh4k^d6o$rar-'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'alinabeel23/beehive',
        'USER': 'alinabeel23',
        'PASSWORD': 'v2_42BUU_JjhXQnaTLGKKuetrgEMfsJi',
        'HOST': 'db.bit.io',
        'PORT': '5432',
    }
}
...
# specify where successful logins should redirect
LOGIN_REDIRECT_URL = '/'
