    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', models.ImageField(null=True, upload_to='images_uploaded')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profilephoto', models.ImageField(blank=True, upload_to='images/')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('video', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='main_app.video')),
            ],
        ),
    ]
